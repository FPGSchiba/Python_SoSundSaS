...
train_input_fn = make_input_fn(dftrain, y_train, 15)  # here we will call the input_function that was returned to us to get a dataset object we can feed to the model
